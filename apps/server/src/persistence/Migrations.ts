...
import Migration0041 from "./Migrations/041_ProjectionThreadSessionExternalControl.ts";
import Migration0042 from "./Migrations/042_RepairProjectionThreadsSettled.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadSessionExternalControl", Migration0041],
  [42, "RepairProjectionThreadsSettled", Migration0042],
] as const;
