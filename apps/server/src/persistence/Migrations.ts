...
import Migration0053 from "./Migrations/053_ProjectionThreadSessionExternalControl.ts";
import Migration0054 from "./Migrations/054_RepairProjectionThreadsSettled.ts";
import Migration0055 from "./Migrations/055_RepairAuthSessionClientConnection.ts";
...
const migrationEntries = [
  ...
  [53, "ProjectionThreadSessionExternalControl", Migration0053],
  [54, "RepairProjectionThreadsSettled", Migration0054],
  [55, "RepairAuthSessionClientConnection", Migration0055],
] as const;
